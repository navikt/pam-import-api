...
data class AdStatePublicDTO(var id:Long?=null, val uuid: String, @Deprecated("Removing soon, not in use") val provider: ProviderInfo? = null, val providerId: Long, val reference: String, val versionId: Long, val ad: AdDTO,
